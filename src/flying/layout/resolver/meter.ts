...
import { ROOT_FONT_SIZE, type MeterProps } from '@flying/widget';
import type { ResolveWidgetSizeOptions } from './types';

export function resolveMeterSize(options: ResolveWidgetSizeOptions): void {
  const props = options.widget.props as MeterProps;
