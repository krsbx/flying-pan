...
import { ROOT_FONT_SIZE, type SliderBarProps } from '@flying/widget';
import type { ResolveWidgetSizeOptions } from '../types';

export function resolveSliderBarSize(options: ResolveWidgetSizeOptions): void {
  const props = options.widget.props as SliderBarProps;
